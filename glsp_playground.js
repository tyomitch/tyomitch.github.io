...
/**
* @param {number} rand_seed
*/
__exports.initEngine = function(rand_seed) {
    wasm.initEngine(rand_seed);
};

/**
* @returns {number}
*/
__exports.width = function() {
    var ret = wasm.width();
    return ret >>> 0;
};
...
async function init(input) {
    ...
    imports.wbg.__wbg_playDraw_78f376c022b3e7f2 = handleError(function(arg0, arg1, arg2) {
        playDraw(arg0, arg1, arg2);
    });
    imports.wbg.__wbg_playSound_b37422e3f8f2a842 = handleError(function(arg0, arg1) {
        try {
            playSound(getStringFromWasm0(arg0, arg1));
        } finally {
            wasm.__wbindgen_free(arg0, arg1);
        }
    });
